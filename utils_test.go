...
func TestExtractTag(t *testing.T) {
	tests := []struct {
		...
		{"forgejo with version", `{"package":{"owner":{"login":"myorg","html_url":"https://git.example.com/myorg"},"type":"container","name":"myapp","version":"2.1.0"}}`, "2.1.0"},
		{"forgejo no version", `{"package":{"owner":{"login":"myorg"},"type":"container","name":"myapp"}}`, ""},
		{"github with container tag", `{"action":"published","package":{"owner":{"login":"myorg"},"package_type":"CONTAINER","name":"myapp","package_version":{"container_metadata":{"tag":{"name":"1.0.0"}}}}}`, "1.0.0"},
